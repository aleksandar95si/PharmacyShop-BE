package fon.master.nst.service.impl;

import fon.master.nst.dto.MailResponse;
import fon.master.nst.dto.MailStatus;
...
public class MailServiceImpl implements MailService {
    ...
    public MailResponse sendPDFReport(String recipientEmail, ShoppingCart shoppingCart) {
        ...
        byte[] reportData;
        try {
            JasperPrint jasperPrint = JasperFillManager.fillReport("C:/Users/aleks/idea-workspace/NST-Project/mail-service/src/main/resources/OrderReport.jasper", new HashMap<String, Object>(), new JRBeanCollectionDataSource(shoppingCart.getCartItems()));
    ...
    private void sendMailWithPDF(String recipient, File tempPdf, Long bill) {
        ...
        try {
            ...
            configuration.setDirectoryForTemplateLoading(new File("C:/Users/aleks/idea-workspace/NST-Project/mail-service/src/main/resources/templates/"));
